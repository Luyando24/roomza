<div class="p-3 sm:p-6 bg-white border-b border-gray-200">
    <div class="mb-6">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-4">Find Your Perfect Home</h1>
        <p class="text-sm sm:text-base text-gray-600">Browse our selection of verified houses and apartments for rent across Zambia.</p>
